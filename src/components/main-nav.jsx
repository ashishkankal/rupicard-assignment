...
const MobileNav = ({ show }) => {
  ...
  return (
    <div className="md:hidden">
      <div className="text-white bg-black bg-opacity-60 shadow-lg">
...
export const MainNav = () => {
  ...
  return (
    <header className="flex absolute z-10 flex-col w-full">
      <div style={{ background: "transparent" }}>
        <div className="flex items-center max-w-[1330px] py-0 px-[20px] md:px-[45px] justify-between">
          <div
